    ...
    async _send () {
      ...
      try {
        ...
        const system = [
          ...
          dsContext,
          '',
          'When responding, prefer Markdown with **bold** labels, bullet points, and small tables for comparisons or only if required. Keep it concise and executive-friendly.'
