        ...
        try {
          if (changedProps.datasets != '') {
            changedProps.datasets =
              '{"TEAM_UTILIZATION": {"schema": ["Team", "Net Availability (Days)", "Project Billable Days", "Project NB Days", "Internal Time", "Billable Util %", "White Space %", "White Space Days"], "types": ["string", "number", "number", "number", "number", "number", "number", "number"], "rows2D": [["Event management", 1176.0, 606.54, 0, 15, 51.58, 47.15, 554.46], ["Project Management", 371.5, 249.5, 25, 0, 67.16, 26.11, 97.0], ["Sales", 655.0, 203.0, 0, 0, 30.99, 69.01, 452.0], ["Technology", 928.0, 280.5, 2, 0, 30.23, 69.56, 645.5]]}, "RESOURCE_UTILIZATION": {"schema": ["Team", "Resource", "FTE Type", "Net Availability (Days)", "Project Billable Days", "Project NB Days", "Internal Time", "Billable Util %", "White Space %", "White Space Days"], "types": ["string", "string", "string", "number", "number", "number", "number", "number", "number", "number"], "rows2D": [["Event management", "Robert Davis", "Part Time", 11.0, 123.5, 0, 0, 1122.7, -1022.73, -112.5], ["Event management", "Natalie Thompson", "Full Time", 262.0, 80.0, 0, 0, 30.5, 69.47, 182.0], ["Event management", "Savitha Krishnamurthi", "Part Time", 131.0, 33.0, 0, 0, 25.2, 74.81, 98.0], ["Event management", "Mykhailo Ivanenko", "Part Time", 131.0, 84.0, 0, 0, 64.1, 35.88, 47.0], ["Event management", "Laura Lewis", "Full Time", 262.0, 90.0, 0, 0, 34.4, 65.65, 172.0], ["Event management", "Andrew Allen", "Full Time", 248.0, 69.04, 0, 15, 27.8, 66.11, 163.96], ["Event management", "Samantha Young", "Full Time", 131.0, 127.0, 0, 0, 96.9, 3.05, 4.0], ["Project Management", "Anna Schmidt", "Part Time", 43.5, 36.0, 2, 0, 82.8, 12.64, 5.5], ["Project Management", "Satish Joshi", "Full Time", 66.0, 48.5, 0, 0, 73.5, 26.52, 17.5], ["Project Management", "Thomas Wilson", "Full Time", 262.0, 87.0, 0, 0, 33.2, 66.79, 175.0], ["Project Management", "Christopher Garcia", "Full Time", 0, 78.0, 23, 0, 0.0, 0.0, -101.0], ["Sales", "Olivia Martinez", "Full Time", 0, 2.5, 0, 0, 0.0, 0.0, -2.5], ["Sales", "Linda Anderson", "Part Time", 131.0, 118.5, 0, 0, 90.5, 9.54, 12.5], ["Sales", "Kateryna Kravchenko", "Full Time", 262.0, 76.0, 0, 0, 29.0, 70.99, 186.0], ["Sales", "Andriy Petrov ", "Full Time", 262.0, 6.0, 0, 0, 2.3, 97.71, 256.0], ["Technology", "Emily Johnson", "Full Time", 262.0, 59.0, 1, 0, 22.5, 77.1, 202.0], ["Technology", "Michael Smith", "Part Time", 76.0, 21.0, 0, 0, 27.6, 72.37, 55.0], ["Technology", "Sarah Lee", "Full Time", 197.0, 101.0, 0, 0, 51.3, 48.73, 96.0], ["Technology", "Natalie Hall", "Full Time", 262.0, 65.0, 0, 0, 24.8, 75.19, 197.0], ["Technology", "Joshua King", "Part Time", 131.0, 34.5, 1, 0, 26.3, 72.9, 95.5]]}}';
              }
